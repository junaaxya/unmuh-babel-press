...
const dummyBooks = [
  ...
  },
  {
    ...
    Halaman: "52",
    image: "/cover2.jpg",
    kategori:"Pedoman Pengenalan Lapangan Persekolahan",
    sinopsis:"Buku pedoman ini merupakan panduan komprehensif bagi mahasiswa Fakultas Keguruan dan Ilmu Pendidikan (FKIP) Universitas Muhammadiyah Bangka Belitung dalam melaksanakan kegiatan Pengenalan Lapangan Persekolahan (PLP 1). Dirancang khusus untuk membantu mahasiswa calon pendidik memahami budaya sekolah dan dinamika pembelajaran—khususnya di masa pandemi—buku ini menyajikan panduan observasi yang terstruktur, mulai dari aspek budaya sekolah hingga adaptasi pembelajaran dalam kondisi pembatasan fisik. Sebagai bagian dari kurikulum wajib, pedoman ini tidak hanya memperkuat bekal teoritis mahasiswa tetapi juga membangun jejaring dan pengalaman praktis yang esensial bagi pengembangan kompetensi keguruan. Dengan pendampingan dari dosen dan guru pembimbing, buku ini menjadi alat vital untuk memastikan PLP 1 berjalan efektif dan bermakna bagi seluruh civitas akademika."
  },
  {
    id: 3,
    Kode_Buku: "-",
  ...
  },
  {
    ...
    image: "/cover11.jpg",
    kategori:"Buku Ajar",
    sinopsis:"Bahan ajar ini dirancang khusus untuk memudahkan pemahaman konsep-konsep baru Ilmu Pengetahuan Alam (IPA) di tingkat Sekolah Dasar. Fokus pada materi getaran dan gelombang, modul ini dilengkapi dengan rangkuman, gambar ilustratif, dan info sains terkait untuk menunjang pembelajaran yang komunikatif dan optimal. Cocok digunakan sebagai referensi guru dalam menyusun kegiatan belajar mengajar yang interaktif, sekaligus membantu siswa menguasai IPA dengan pendekatan visual dan praktis. Buku ini juga menyertakan contoh penerapan konsep dalam kehidupan sehari-hari, menjadikan IPA lebih relevan dan menarik untuk dipelajari."
  },
];
