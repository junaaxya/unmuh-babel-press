...
const Card = ({ 
  ...
  const variantClasses = {
    ...
    video: `
      ...
      ${hover ? 'hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] hover:-translate-y-3 hover:scale-[1.03]' : ''}
    `,
    glass: `
      bg-white/10 backdrop-blur-xl rounded-2xl 
      shadow-[0_8px_32px_0_rgba(31,38,135,0.37)]
      border border-white/20
      ${hover ? 'hover:bg-white/20 hover:shadow-[0_25px_50px_-12px_rgba(31,38,135,0.5)] hover:-translate-y-2' : ''}
    `,
    neon: `
      ...
      ${hover ? 'hover:shadow-[0_0_30px_rgba(168,85,247,0.4)] hover:-translate-y-2' : ''}
    `
  };
      ...
      <div className="p-4 space-y-3">
        ...
        {isPlaying && (
          <div className="w-full bg-gray-700 rounded-full h-1 overflow-hidden">
            <div className="bg-red-600 h-1 rounded-full animate-pulse" style={{width: '30%'}}></div>
          </div>
        )}
      </div>
    </Card>
