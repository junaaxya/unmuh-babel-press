// src/components/Kontak/FloatingWhatsApp.js
"use client";
...
export default function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Tooltip */}
      {showTooltip && (
        <div className="absolute bottom-16 right-0 mb-2 animate-pulse">
          <div className="bg-gray-900 text-white text-sm py-2 px-3 rounded-lg shadow-lg whitespace-nowrap relative">
      ...
      <button
        ...
        className="group relative w-16 h-16 bg-green-500 hover:bg-green-600 rounded-full shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300 flex items-center justify-center animate-pulse hover:animate-none"
