  ...
  return (
    <AuthGuard>
      <div className="min-h-screen flex bg-gray-50">
        ...
        >
          {/* Sidebar Header */}
          <div className={`p-6 border-b border-blue-700/50 ${!sidebarOpen && !isMobile ? 'px-2' : ''}`}>
            <div className="flex items-center justify-between">
              <div className={`text-center flex-1 ${!sidebarOpen && !isMobile ? 'hidden' : ''}`}>
          ...
          {/* Logout Button */}
          <div className={`p-4 border-t border-blue-700/50 ${!sidebarOpen && !isMobile ? 'px-2' : ''}`}>
            <button
