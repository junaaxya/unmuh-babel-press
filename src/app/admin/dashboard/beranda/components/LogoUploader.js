...
export default function LogoUploader({
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            // Pastikan fungsi ini throw error jika gagal upload
            const response = await uploadLogo(file); // misal return json atau status

            // Baru preview diubah jika upload berhasil
            const reader = new FileReader();
            reader.onload = (e) => {
                setCurrentLogo(e.target.result); // preview update
            };
    ...
    const currentImage = preview || currentLogo;
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">
                            Upload logo untuk ditampilkan di header website
                        </p>
                    </div>
                </div>
            </div>
                ...
                >
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="text-xs text-gray-400 space-y-1">
                            ...
                            <p>
                                Rekomendasi: Logo dengan background transparan
                                (PNG)
                            </p>
                        </div>
                    </div>
